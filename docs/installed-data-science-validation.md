...
remains hidden and opt-in. CF-14.03 owns the installed Library/CLI, default
Copier, compatibility, selection, filesystem-failure, and cleanup regression
matrix. CF-14.04 owns the create-forge changelog, tag, publication, and release
verification.
